...
class MainActivity : AppCompatActivity() {
    ...
    private fun doInference() {
        ...
        val list: List<Classifier.Recognition> = classifier!!.recognizeImage(rotatedBmp!!)
        ...
        for (i in list.indices) {
                canvas.drawText(
                    ...
                    list[i].getLocation().left,
                    list[i].getLocation().top,
                    paintText
                )
                canvas.drawRect(list[i].getLocation(), p)
        }
